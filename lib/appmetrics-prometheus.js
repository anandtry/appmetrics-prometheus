...
var monitor = function(options) {
  ...
  function site(req, res) {
    ...
    var eventloopData = stringEventLoopData();
  ...
  function stringEventLoopData() {
    var content = '';
    content += '# HELP os_eventloop_latency_min summarising sample based information of the event loop latency (shortest) \n';
    content += '# TYPE os_eventloop_latency_min gauge\n';
    content += 'os_eventloop_latency_min ' + latestEventLoopEvent.latency.min + '\n';
    content += '# HELP os_eventloop_latency_max summarising sample based information of the event loop latency (longest) \n';
    content += '# TYPE os_eventloop_latency_max gauge\n';
    content += 'os_eventloop_latency_max ' + latestEventLoopEvent.latency.max + '\n';
    content += '# HELP os_eventloop_latency_avg summarising sample based information of the event loop latency (average) \n';
    content += '# TYPE os_eventloop_latency_avg gauge\n';
    content += 'os_eventloop_latency_avg ' + latestEventLoopEvent.latency.avg + '\n';
    return content;
  }
